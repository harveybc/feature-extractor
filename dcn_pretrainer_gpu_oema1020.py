# dcn_pretrainer_gpu_oema1020: Trains a dcn for each action, exports predicted results as csv,
...
class QPretrainer():    
    ...
    def set_dcn_model_r(self):
        ...
        model.add(Conv1D(512, 3, strides = 2, activation='relu', use_bias = False, input_shape=(self.num_features, self.window_size)))
    ...
    def export_model(self, signal):
        self.svr_rbf.save(self.model_prefix + str(signal)+'_oema1020.dcn') 
