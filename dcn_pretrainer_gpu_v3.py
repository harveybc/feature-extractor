...
class QPretrainer():    
    ...
    def set_dcn_model_r(self):
        ...
        model.add(LSTM(units = 256, recurrent_dropout = 0.6, return_sequences = True, input_shape=(self.num_features,self.window_size))) 
        model.add(BatchNormalization())
        model.add(LSTM(units = 128, recurrent_dropout = 0.6, return_sequences = True)) 
        model.add(BatchNormalization())
        model.add(LSTM(units = 64, recurrent_dropout = 0.6))            
        model.add(BatchNormalization())
