...
class QPretrainer():    
    ...
    def set_dcn_model_r(self):
        ...
        #model.add(Conv1D(150, 3, use_bias=False))
        #model.add(BatchNormalization())
        ...
        #model.add(BatchNormalization())
        #e<                 TT65model.add(Activation('relu'))#model.add(Dropout(0.6))
        #model.add(Conv1D(64, 3, use_bias=False))
        #model.add(BatchNormalization())
        #model.add(Activation('relu'))
        ...
        model.add(LSTM(units = 256, recurrent_dropout = 0.4, return_sequences = True, input_shape=(self.num_features,self.window_size))) 
        model.add(BatchNormalization())
        model.add(LSTM(units = 128, recurrent_dropout = 0.4, return_sequences = True)) 
        model.add(BatchNormalization())
        model.add(LSTM(units = 64, recurrent_dropout = 0.4))            
        model.add(BatchNormalization())
