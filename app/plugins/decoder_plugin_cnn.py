...
class Plugin:
    ...
    def configure_size(self, interface_size, output_shape):
        ...
        for size in layer_sizes[1:-1]:
            ...
            self.model.add(Conv1DTranspose(filters=size, kernel_size=kernel_size, padding='same', activation=LeakyReLU(alpha=0.1), kernel_initializer=HeNormal(), kernel_regularizer=l2(0.01)))
        ...
        self.model.add(Conv1DTranspose(filters=output_shape, kernel_size=kernel_size, padding='same', activation=LeakyReLU(alpha=0.1), kernel_initializer=HeNormal(), kernel_regularizer=l2(0.01), name="decoder_output"))
