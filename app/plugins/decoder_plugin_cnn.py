...
class Plugin:
    ...
    def configure_size(self, interface_size, output_shape):
        ...
        self.model.add(Dense(flatten_shape, input_shape=(interface_size,), activation='leaky_relu', kernel_initializer=HeNormal(), name="decoder_in"))
        ...
        for size in layer_sizes:
            ...
            self.model.add(Conv1DTranspose(filters=size, kernel_size=kernel_size, padding='same', activation='leaky_relu ', kernel_initializer=HeNormal(), kernel_regularizer=l2(0.01)))
