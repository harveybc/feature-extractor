...
class EpochEndLogger(tf.keras.callbacks.Callback): # Changed to tf.keras
    def on_epoch_end(self, epoch, logs=None):
        ...
        # MAE: Keras should prepend output name 'reconstruction_out' to the metric class name 'mean_absolute_error'.
        mae_key = 'reconstruction_out_mean_absolute_error' # UPDATED EXPECTED KEY
        if mae_key in logs: 
        ...
        val_mae_key = f"val_{mae_key}" # Expected "val_reconstruction_out_mean_absolute_error"
