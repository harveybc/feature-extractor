...
class Plugin:
    ...
    def configure_size(self, interface_size, output_shape):
        ...
        for size in layer_sizes:
            ...
            self.model.add(Conv1DTranspose(filters=size, kernel_size=kernel_size, padding='same', activation='tanh', kernel_initializer=HeNormal(), kernel_regularizer=l2(0.01)))
