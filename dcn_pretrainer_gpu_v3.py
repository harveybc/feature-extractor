...
#                 q-agent.
# v3 uses both classification and regression signals
...
class QPretrainer():    
    ...
    def set_dcn_model_r(self):
        ...
        model.add(LSTM(units = 128, return_sequences = True, dropout = 0.4, recurrent_dropout = 0.4, input_shape=(self.num_features,self.window_size))) 
        model.add(LSTM(units = 64, return_sequences = True, dropout = 0.4, recurrent_dropout = 0.4, input_shape=(self.num_features,self.window_size)))            
        model.add(LSTM(units = 32, return_sequences = True, dropout = 0.4, recurrent_dropout = 0.4, input_shape=(self.num_features,self.window_size)))                        
