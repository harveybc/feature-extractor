...
def parse_args():
    ...
    parser.add_argument('-ep', '--encoder_plugin', type=str, help='Name of the encoder plugin to use.')
    parser.add_argument('-dp', '--decoder_plugin', type=str, help='Name of the decoder plugin to use.')
