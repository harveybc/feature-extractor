...
class AutoencoderManager:
    ...
    def _compile_model(self, config):
        ...
        # This function should return [calculate_mae_for_reconstruction]
        ...
        # This will be the 'calculate_mae_for_reconstruction' function
        mae_fn_for_compile = helper_mae_functions[0] 

        tf.print(f"DEBUG: Attempting to compile with 'reconstruction_out' metric: custom MAE function (name: {mae_fn_for_compile.__name__}), and pass-through metrics for KL components.")
        ...
        self.autoencoder_model.compile(
            ...
            metrics={ 
                # Use the custom MAE function for reconstruction_out
