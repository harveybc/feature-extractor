...
def merge_config(defaults, plugin_params1, plugin_params2, file_config, cli_args, unknown_args):
    ...
    for k, v in plugin_params2.items():
        ...
        merged_config[k] = v
    print(f"After plugin-specific parameters: {merged_config}")

    # Step 2: Merge with default values from config.py (override plugin-specific)
