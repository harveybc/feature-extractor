...
class QPretrainer():    
    ...
    def set_dcn_model_r(self):
        ...
        model.add(TimeDistributed(Conv1D(512, 5, strides = 2, use_bias = False, activation = 'relu'), input_shape=(1,self.window_size, self.num_features))) 
    ...
    def train_model(self, signal):
        ...
        #self.x.reshape(-1, self.num_features, self.window_size, 1)
    ...
    def evaluate_validation(self, params, signal):
        ...
        #self.x_v.reshape(-1, self.num_features, self.window_size, 1)
